...
public class MainActivity extends Activity {
	...
	SessionManager session;
	 ...
	 protected void onStart() {
	        super.onStart();
	        Log.i("here is it", "On Start .....");
	     // Restore preferences
	        /*SharedPreferences settings = getSharedPreferences("LowaSoftPref", 0);
	        boolean loggedIn = settings.getBoolean("IsLoggedIn", true);
	        if(!loggedIn){
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("Main Activity", "Main is here???");
